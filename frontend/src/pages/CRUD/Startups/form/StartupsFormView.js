...
const StartupsForm = (props) => {
  ...
  const renderForm = () => (
    <Widget title={'View startups'} collapse close>
            ...
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {startupsFields['startupName'].label}
                </Typography>
                <Typography>{form.values.startupName}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {startupsFields['contactPerson'].label}
                </Typography>
                <Typography>{form.values.contactPerson}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {startupsFields['phoneNumber'].label}
                </Typography>
